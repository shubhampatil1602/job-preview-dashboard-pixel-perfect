const Navbar = () => {
  return (
    <>
      <div className='w-[108rem] h-[6.875rem] bg-white border-b flex pl-10 pr-6 items-center fixed top-0'>
        <div className='w-[104rem] h-[3.8125rem] flex justify-between'>
          ...
          <div className='w-[33.625rem] h-[4.625rem] border rounded-full flex justify-between p-2 relative bottom-2 right-[7.4rem]'>
          ...
          <div className='w-[8.375rem] h-[3.75rem] flex justify-center items-center gap-3'>
            <img
              src='/ghanta.png'
              alt='bell'
              className='w-8 h-[32px] mt-[3px]'
            />
            <div className='flex justify-center items-center gap-2'>
              <img src='/atlassian2.png' alt='atlassian' className='w-8 h-8' />
              <img src='/down.png' alt='down' className='h-2 w-3' />
            </div>
          </div>
        </div>
      </div>
